                ...
                <nav class="p-4 space-y-1">
                    ...
                    <div class="space-y-1">
                        ...
                        <div v-show="customerSubmenuOpen" class="ml-8 space-y-1">
                            <!-- ✅ Đã thêm tab Tất cả -->
                            <Link :href="route('admin.customers.index', { type: 'all' })" class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm transition-all" :class="route().current('admin.customers.index') && route().params?.type === 'all' ? 'sidebar-item-active text-primary' : 'text-on-surface-variant hover:bg-hover-bg hover:text-primary'">👥 Tất cả</Link>
