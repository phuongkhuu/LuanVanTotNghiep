	...
	<div class="main-container">
		<div class="editor-container editor-container_classic-editor">
			<div class="editor-container__editor">
				<ckeditor v-if="editor && config" :modelValue="config.root.initialData" :editor="editor" :config="config" />
			</div>
		</div>
	</div>
</template>
 ...
 * https://ckeditor.com/ckeditor-5/builder/#installation/NoNgNARAzAdAjDATBSB2ALK1iqoAwgCs66RAHAJyIVR757q16GFx5znooQCmAdijxhgcMEKGiJAXUgATMrMUAjZFKA==
 */
